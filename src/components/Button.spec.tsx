...
it('matches snapshot', () => {
  const { toJSON } = render(<Button onPress={() => {return}} text={'TEST'}/>)
...
it('accepts custom styles', () => {
  const { getByTestId } = render(<Button text='asd' onPress={() => {return}} style={{ backgroundColor: 'red' }}/>)
...
it('accepts custom text styles', () => {
  const { getByTestId } = render(<Button text='asd' onPress={() => {return}} textStyle={{ color: 'red' }}/>)
